...
<div class="modal fade" id="registro_proveedor" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formRegistrarProveedor" method="POST">
                <h6>Ingresar un nuevo proveedor</h6>

                <div class="modal-body d-flex flex-column gap-1">
                    <div>
                        <label for="tit">Nombre</label>
                        <input class="form-control" id="NombreProveedor" type="text" name="Nombre_Proveedor"
                            placeholder="Ingrese nombre de proveeedor">
                        <div class="invalid-feedback">Ingrese el Nombre del Proveedor Correctamente</div>
                    </div>
                    <div>
                        <label for="tit">Direccion </label>
                        <input class="form-control" id="DireccionProveedor" type="text" name="Direccion"
                            placeholder="ingrese direccion de proveedor">
                        <div class="invalid-feedback">Ingrese la Direccion Correctamente</div>
                    </div>
                    <div>
                        <label for="tit">Numero de Contacto</label>
                        <input class="form-control" id="TelefonoProoveedor" type="number" name="Numero_telefono"
                            placeholder="Ingrese numero telefonico">
                        <div class="invalid-feedback">Ingrese Correctamente el Numero de Telefono</div>
                    </div>
                    <div>
                        <label for="tit">Correo</label>
                        <input class="form-control" id="CorreoProveedor" type="email" name="Correo_elect"
                            placeholder="Ingrese correo electronico de proveedor">
                        <div class="invalid-feedback">Ingrese el Correo Electronico Correctamente</div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                    <button type="submit" class="btn btn-primary" name="registrar" onsubmit="confirmarGuardar()">Enviar
                        Proveedor</button>
                </div>
            </form>
        </div>
...
<div class="table-responsive">
    <table id="tablaProveedores" class="table table-hover table-striped text-center table-bordered">
                        ...
                        <td>
                            <form method="POST" style="display:inline;">
                                ...
                                <button class="btn btn-success" title="editar_proveedor" type="button" name="seleccion"
                                    ...
                                    data-cod="<?= $prov['cod_proveedor'] ?>" data-nombre="<?= $prov['Nombre_Proveedor'] ?>"
                                    data-direccion="<?= $prov['Direccion'] ?>" data-telefono="<?= $prov['Numero_telefono'] ?>"
            ...
            <form method="POST" id="editarForm">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="Nombre_Proveedor" id="NombreProveedorEdit"
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="Direccion" id="DireccionProveedorEdit"
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="number" name="Numero_telefono" id="TelefonoProveedorEdit"
                            placeholder="Ingrese el número de teléfono modificado del proveedor">
                        <div class="invalid-feedback">Ingrese el Telefono del Proveedor Correctamente</div>
                    </div>

                    <div class="mb-3">
                        <label for="correoProveedor" class="form-label">Correo electronico</label>
                        <input class="form-control" type="email" name="Correo_elect" id="CorreoProveedorEdit"
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" name="editar_proveedor"
                        onsubmit="confirmarEditar()">Guardar Cambios</button>
...
<script type="module" src="Assets/js/validaciones/gestionProveedores.js"></script>
