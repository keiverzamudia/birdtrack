  ...
  <?php } else { ?>
    ...
    <div class="card mt-5">
      <div class="card-head">
        ...
        <button type="button" id="btnformularioTipoActivo" class="btn btn-success my-2" data-bs-toggle="modal" data-bs-target="#formulario_tipo_activo">
          Tipo de Activo
        </button>
      </div>
      <div class="card-body">
      ...
      <div class="modal-content">
        ...
        <form method="POST">
          <div class="modal-body d-flex flex-column gap-4">
            ...
            <input class="form-control" type="text" name="Descripcion" placeholder="Descripcion del Activo con Caracteristica" required>
            <input class="form-control" type="date" name="Fecha_adquisicion" placeholder="fecha_adquisicion" required>
          </div>
