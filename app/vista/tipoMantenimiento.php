...
<div class="container mb-5 p-5">
    ...
    <form method="post">
        ...
        <button type="submit" id="enviar" name="enviar" class="btn btn-success">Registrar Tipo Mantenimiento</button>
                        ...
                        <form method="POST">
                            ...
                            if (isset($tipo_mantenimiento)) {
                                foreach ($tipo_mantenimiento as $tipo) {
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header bg-danger">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Confirmar eliminación
                                                    </h1>
                                    ...
                                    <!--modal de edicion-->
                                    <div class="modal fade" id="editar<?= $tipo['id_tipo_mantenimiento'] ?>"
                                        data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                        aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Registro de
                                                        Mantenimiento</h1>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    <form method="post">
                                                        <div class="mb-4">
                                                            <label for="nombre_mtto" class="form-label">Nombre del
                                                                Mantenimiento</label>
                                                        ...
                                                        <div class="form-floating mb-4">
                                                            ...
                                                            <label
                                                                for="floatingTextarea2"><?php echo $tipo['Descripcion'] ?></label>
                                                        </div>
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" class="btn btn-success p-2"
                                                                data-bs-toggle="modal" title="editar" name="editar"
